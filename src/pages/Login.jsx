    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-light text-white tracking-wide mb-2">Welcome Back</h2>
          <p className="text-slate-400 text-sm">Access your personalized travel itineraries.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="flex justify-end">
            <a href="#" className="text-xs font-bold text-[#4ade80] hover:text-white transition-colors">Forgot Password?</a>
          </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          Don't have an account? <Link to="/register" className="text-white font-bold hover:text-[#4ade80] transition-colors">Create one</Link>
        </div>
      </motion.div>
    </div>
  );
